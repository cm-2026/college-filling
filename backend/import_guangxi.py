...
# ── 读取Excel ──────────────────────────────────────────
df = pd.read_excel('C:/Users/Administrator/Desktop/广西数据.xlsx')
...
# ── ID偏移量 ───────────────────────────────────────────
ID_OFFSET = 300000  # 广西数据 ID = 行号(1~N) + 300000
# 已有ID策略：
# 河南: 1~60585
# 北京: 100001~105751 (偏移量100000)
# 福建: 200001~226144 (偏移量200000)
...
for idx, row in df.iterrows():
    ...
    try:
        rec = (
            ...
            to_str(row['source_province'], '广西'),     # source_province
